...
화면에서 난 오류와 웹 바이탈을 인프라팀의 Grafana로 보내고, API 요청에 추적 헤더를 실어 백엔드 로그와 잇습니다. 수집 주소와 키가 있는 환경에서만 켜지고, 첫 화면이 뜬 뒤에 따로 불러와 초기 로딩을 늦추지 않습니다.
