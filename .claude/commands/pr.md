...
4. **README.md 정확성 확인** — 이번 작업으로 README의 서술이 사실과 달라졌는지 본다(스크립트 표·기술 스택 표·폴더 구조·기능 소개·실행 방법). 달라졌으면 갱신해 이 브랜치에 커밋한다. **README는 프로젝트 소개 문서이므로 진행 상황이나 작업 목록을 적지 않는다.** 해당 없으면 건드리지 않는다.
