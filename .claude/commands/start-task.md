...
2. **GitHub 이슈 생성** — `gh issue create`로 제목 `유형: 설명`, 알맞은 라벨과 마일스톤을 달고, 본문은 `.github/ISSUE_TEMPLATE`의 해당 템플릿에서 **필수 항목을 빠짐없이** 채우고(기능은 어떤 문제·제안, 버그는 무엇이 잘못됐나·재현 절차·기대한 동작·실제 동작·환경), 마지막에 완료 기준을 덧붙인다.
