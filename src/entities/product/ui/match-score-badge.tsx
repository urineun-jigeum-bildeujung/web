...
//
// 아직 재지 않은 상품(score가 null)은 메인 시안에 없는 상태다 — 메인 목데이터가
// 애초에 이 경우를 안 다뤄서 시안이 그릴 필요가 없었을 뿐이다. 검색 결과 화면은
// 실제로 영양 정보 미등록 상품이 있어 이 상태를 겪고, IA 기준으로 먼저 만든
// "정보 확인 중" 표시(#119, 시안 확정 전)가 여전히 필요하다. 0점으로 내려보내면
// "궁합이 나쁜 상품"처럼 읽혀 아직 안 잰 것과 헷갈린다.
