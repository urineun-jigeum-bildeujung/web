...
**시트 제목의 아이는 항목의 `petId`가 정한다.** 그 제품을 어느 아이에게 사 줬는지인데 백엔드가 아직 `null`로 둔다(주문 서비스 내부 응답에 없어 "추후 연동"). 그때까지는 대표 아이 이름을 쓴다. 등록 요청도 아이를 받지 않아 아이 단위 적합도 반영은 백엔드 보강 뒤의 일이다.
