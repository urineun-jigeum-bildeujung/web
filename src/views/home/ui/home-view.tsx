...
const SCREEN_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/mypage/restock", label: "재입고 알림", hint: "mypa_021" },
      { href: "/mypage/reviews", label: "나의 상품 후기", hint: "mypa_031" },
      { href: "/mypage/payment", label: "결제 수단 관리", hint: "mypa_041" },
      { href: "/mypage/orders", label: "주문·배송 확인", hint: "mypa_051" },
      { href: "/mypage/support", label: "고객지원", hint: "mypa_061" },
      { href: "/mypage/settings", label: "설정", hint: "mypa_071" },
    ],
  },
  {
    title: "개발용",
