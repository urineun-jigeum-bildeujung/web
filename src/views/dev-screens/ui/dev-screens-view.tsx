// 만들어 둔 화면으로 들어가는 개발용 입구.
// 시안의 메인이 `/`를 차지하면서 이리로 옮겼다. 자리 표시 화면이 남아 있는 동안은
// 이 목록으로 확인하는 편이 빠르다. 프로덕션에서는 열리지 않는다.
...
const SCREEN_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/products/1/photos", label: "사진 리뷰 전체보기", hint: "상품 상세_사진 리뷰 모음" },
    ],
  },
  {
    title: "상품 비교",
...
export function DevScreensView() {
  return (
