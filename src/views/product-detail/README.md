...
**과다 배지의 글자색은 `destructive-foreground`다.** 어두운 화면의 `--destructive`가 라이트보다 밝아서, 흰 글자를 얹으면 대비가 2.89:1까지 떨어진다. 같은 이유로 `--success-foreground`도 흰색이 아니라 어두운 색이다(흰 글자면 3.26:1).
