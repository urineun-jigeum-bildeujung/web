...
**과다·적정 배지의 글자색은 각각 `destructive-foreground`·`success-foreground`를 사용한다.** 현재는 Figma 컴포넌트에 맞춰 두 토큰 모두 흰색을 사용한다. 배경과 흰 글자의 대비가 기준보다 낮은 조합은 PD팀과 후속 논의한 뒤 색상을 조정한다.
